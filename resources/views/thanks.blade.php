...
@section('content')
    ...
    <p>
        ...
        on {{ $booking->groupSession->date->format('l jS F Y') }} at {{ $booking->groupSession->session->human_start_time }}.
    </p>
    <p class="mt-2">
        <a class="font-semibold hover:underline" href="/{{ $booking->groupSession->group->slug }}">Back to group...</a>
    </p>
@endsection
